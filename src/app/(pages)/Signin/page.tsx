...
export default function Login() {
    ...
    return (
        <main className="min-h-screen bg-[#FDF6F6] text-black">
            ...
            <h1 className="font-bold p-2">Exemplo para ajudar na tela de cadastro</h1>

            {/* Flex flex-col alinha os itens um embaixo do outro (vertical) */}
            <div className="flex flex-col items-center gap-4 py-6">
                <div className="w-32 h-32 border-2 flex items-center justify-center border-gray-400 bg-white">
                    Example div
                </div>
                ...
                <button className="ml-4 w-1/4 max-w-md bg-teal-400 text-white py-2 rounded-lg font-semibold mt-2 hover:bg-gray-600">
                    Button
                </button>
            </div>
            ...
            <div className="flex flex-row justify-center items-center gap-1 md:gap-6 mt-10">
                ...
                <div className="w-24 h-24 bg-gray-400 flex items-center justify-center rounded-lg text-white">
                    3
                </div>
            </div>
        </main>
